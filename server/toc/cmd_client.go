...
func (s OSCARProxy) RemoveBuddy2(ctx context.Context, me *state.Session, args []byte) []string {
...
func (s OSCARProxy) SendIMEnc(ctx context.Context, sender *state.Session, args []byte) []string {
